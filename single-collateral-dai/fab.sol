...
contract TubFab {
    function newTub(DSToken sai, DSToken sin, DSToken skr, ERC20 gem, DSToken gov, DSValue pip, DSValue pep, SaiVox vox, GemPit pit) public returns (SaiTub tub) {
...
contract DaiFab is DSAuth {
    ...
    function makeVoxTub(ERC20 gem, DSToken gov, DSValue pip, DSValue pep, GemPit pit) public auth {
        require(step == 1);
    ...
    function S(string memory s) internal pure returns (bytes32) {
