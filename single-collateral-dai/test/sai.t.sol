...
contract DevTubFab {
    function newTub(DSToken sai, DSToken sin, DSToken skr, DSToken gem, DSToken gov, DSValue pip, DSValue pep, SaiVox vox, GemPit pit) public returns (DevTub tub) {
...
contract DevDadFab {
    function newDad() public returns (DSGuard dad) {
        ...
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).sai()), bytes4(keccak256('mint(uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).sai()), bytes4(keccak256('burn(uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).sai()), bytes4(keccak256('mint(address,uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).sai()), bytes4(keccak256('burn(address,uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).sin()), bytes4(keccak256('mint(uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).sin()), bytes4(keccak256('burn(uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).sin()), bytes4(keccak256('mint(address,uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).sin()), bytes4(keccak256('burn(address,uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).skr()), bytes4(keccak256('mint(uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).skr()), bytes4(keccak256('burn(uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).skr()), bytes4(keccak256('mint(address,uint256)')));
        dad.permit(DaiFab(msg.sender).owner(), address(DaiFab(msg.sender).skr()), bytes4(keccak256('burn(address,uint256)')));
...
contract SaiTestBase is DSTest, DSMath {
    ...
    function setUp() virtual public {
        ...
        sai = DSToken(address(daiFab.sai()));
        sin = DSToken(address(daiFab.sin()));
        skr = DSToken(address(daiFab.skr()));
        vox = DevVox(address(daiFab.vox()));
        tub = DevTub(address(daiFab.tub()));
        tap = SaiTap(address(daiFab.tap()));
        top = DevTop(address(daiFab.top()));
        mom = SaiMom(address(daiFab.mom()));
...
contract SaiTubTest is SaiTestBase {
    ...
    function testMold() public {
        ...
        // assertTrue(mom.call(abi.encodePacked(setCap, 0 ether)));
        // (bool success,) = address(mom).call(abi.encodeWithSignature("setAxe(uint256)", 0 ether));
        // (bool success,) = address(mom).call(abi.encodeWithSignature("setAxe(uint256)", 0 ether));
        // (bool success,) = address(mom).call(abi.encodeCall(SaiMom.setAxe, 0 ether));
        // assertTrue(success);
        // assertTrue(mom.call(setCap, 5 ether));
        // (success,) = address(mom).call(abi.encodeCall(Sai))
        mom.setAxe(0 ether);

        try mom.setAxe(ray(2 ether)) {
        ...
        mom.setMat(ray(2 ether));
        mom.setAxe(ray(2 ether));
        try mom.setMat(ray(1 ether)) {
            assertTrue(false);
        } catch {}
    }
    ...
    function testPriceFeedSetters() public {
        // uint256 setPip = bytes4(keccak256('setPip(address)'));
        // uint256 setPep = bytes4(keccak256('setPep(address)'));
        // uint256 setVox = bytes4(keccak256('setVox(address)'));
        ...
        mom.setPip(DSValue(address(0x1)));
        mom.setPep(DSValue(address(0x2)));
        mom.setVox(SaiVox(address(0x3)));
        assertTrue(address(tub.pip()) == address(0x1));
        assertTrue(address(tub.pep()) == address(0x2));
        assertTrue(address(tub.vox()) == address(0x3));
    }
    ...
    function testBiteOverParity() public {
        ...
        uint256 skr_before = skr.balanceOf(address(this));
...
contract CageTest is SaiTestBase {
    ...
    function testCageUnsafeOverCollat() public {
        ...
        tub.join(20 ether);   // give us some more skr
        uint256 price = wdiv(3 ether, 4 ether);
        mark(price);
        top.cage();        // 150% collat
        ...
        uint256 saved = rmul(5 ether, rdiv(WAD, price));
    ...
    function testCageAtCollat() public {
        ...
        uint256 price = wdiv(1 ether, 2 ether);  // 100% collat
        mark(price);
        top.cage();
    ...
    function testCageUnderCollat() public {
        ...
        uint256 price = wdiv(1 ether, 4 ether);   // 50% collat
        mark(price);
        top.cage();
    ...
    function testCashUnsafeOverCollat() public {
        ...
        uint256 ink = tub.ink(cup);
        uint256 tab = tub.tab(cup);
        uint256 skrToRecover = sub(ink, wdiv(tab, price));
        tub.bite(cup);
        tub.free(cup, tub.ink(cup));
    ...
    function testFailCashAtCollatFreeSkrExitBeforeBail() public {
        ...
        uint256 gemBySAI = wmul(5 ether, 2 ether);
        uint256 gemBySKR = wdiv(wmul(20 ether, 30 ether - gemBySAI), 30 ether);
    ...
    function testThreeCupsAtCollat() public {
        ...
        uint256 price = wdiv(1 ether, 2 ether);
        mark(price);
        top.cage();
    ...
    function testThreeCupsUnderCollat() public {
        ...
        uint256 price = wdiv(1 ether, 4 ether);
        mark(price);
        top.cage();
    ...
    function testThreeCupsSKRZeroValue() public {
        ...
        uint256 price = wdiv(1 ether, 20 ether);
        mark(price);
        top.cage();
    ...
    function testPeriodicFixValue() public {
        ...
        uint256 price = rdiv(9 ether, 8 ether);
        mark(price);
        top.cage();
    ...
    function testShutEmptyCup() public {
        bytes32 cup = tub.open();
        // uint256 (lad,,,) = tub.cups(cup);
        // (address lad, uint256 ink, uint256 art, uint256 ire) = tub.cups(cup);
...
contract LiquidationTest is SaiTestBase {
    function liq(bytes32 cup) internal returns (uint256) {
        ...
        uint256 jam = rmul(tub.ink(cup), tub.per());  // this many eth
        uint256 con = rmul(tub.tab(cup), vox.par());  // this much ref debt
        uint256 min = rmul(con, tub.mat());        // minimum ref debt
        return wdiv(min, jam);
    }
    ...
    function collat(bytes32 cup) internal returns (uint256) {
        ...
        uint256 pro = rmul(tub.ink(cup), tub.tag());
        uint256 con = rmul(tub.tab(cup), vox.par());
        return wdiv(pro, con);
    }
    ...
    function testBustMint() public {
        ...
        uint256 sai_before = sai.balanceOf(address(this));
        uint256 skr_before = skr.balanceOf(address(this));
        assertEq(sai_before, 16 ether);
        tap.bust(2 ether);
        uint256 sai_after = sai.balanceOf(address(this));
        uint256 skr_after = skr.balanceOf(address(this));
...
contract GapTest is SaiTestBase {
    ...
    function setUp() public override(SaiTestBase) {
        super.setUp();
    ...
    function testGapJoin() public {
        ...
        uint256 skr_before = skr.balanceOf(address(this));
        uint256 gem_before = gem.balanceOf(address(this));
        tub.join(100 ether);
        uint256 skr_after = skr.balanceOf(address(this));
        uint256 gem_after = gem.balanceOf(address(this));
...
contract FeeTest is SaiTestBase {
    ...
    function testFeeWipeAll() public {
        ...
        uint256 owe = tub.rap(cup);
        assertEq(owe, 5 ether);

        // uint256 ( , , art, ire) = tub.cups(cup);
        (address lad, uint256 ink, uint256 art, uint256 ire) = tub.cups(cup);
